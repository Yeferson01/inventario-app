-- Fase 6.15F.2 - Patch sync conflict operation helper
-- Objetivo:
-- Corregir private.create_sync_conflict_for_mutation(...)
-- para insertar sync_conflicts.operation, columna NOT NULL en el esquema actual.
...
is 'Creates a sync conflict for a mutation, including required operation and valid severity, then marks the mutation as conflict.';
