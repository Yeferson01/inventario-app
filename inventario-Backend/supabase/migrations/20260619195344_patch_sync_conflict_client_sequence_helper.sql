-- Fase 6.15F.4 - Patch sync conflict client_sequence helper
-- Objetivo:
-- Corregir private.create_sync_conflict_for_mutation(...)
-- para insertar sync_conflicts.client_sequence, columna NOT NULL.
...
is 'Creates a sync conflict for a mutation, including required operation, client_mutation_id, client_sequence and valid severity, then marks the mutation as conflict.';
